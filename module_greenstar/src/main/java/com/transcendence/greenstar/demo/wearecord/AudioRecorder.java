...
public class AudioRecorder implements RecordListener {

	private MediaRecorder recorder;
	private String fileName;
	private String fileFolder = Global.DIRECTORY.RECORD;//Environment.getExternalStorageDirectory().getPath() + "/TestRecord";
