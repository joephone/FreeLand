package com.transcendence.greenstar.demo.shoppingcart;
...
import com.transcendence.greenstar.demo.shoppingcart.adapter.RightDishAdapter;
import com.transcendence.greenstar.demo.shoppingcart.dialog.ShopCartDialog;
import com.transcendence.greenstar.demo.shoppingcart.imp.ShopCartImp;
import com.transcendence.greenstar.demo.shoppingcart.model.Dish;
...
import com.transcendence.greenstar.demo.shoppingcart.widget.FakeAddImageView;
import com.transcendence.greenstar.demo.shoppingcart.widget.PointFTypeEvaluator;

import java.util.ArrayList;

public class ShoppingCartActivity extends AppAc implements LeftMenuAdapter.onItemSelectedListener, ShopCartImp,ShopCartDialog.ShopCartDialogImp{
...
//    private FakeAddImageView fakeAddImageView;
    ...
    protected int getLayoutId() {
        return R.layout.activity_demo_shopping_cart;
    }
...
//                            Log.e(TAG, "onScrolled: "+headerLayout.getTranslationY()+"   "+headerLayout.getBottom()+"  -  "+headerLayout.getMeasuredHeight() );
                            ...
                            LogUtils.d( "onScrolled: "+menu.getMenuName() );
                        }
                    }
                }
            }
