package com.transcendence.greenstar.demo.zxing;
...
import com.transcendence.zxing.activity.CaptureActivity;
 ...
 * @desc
 */
public class ZxingMain  extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_zxing_main);
        initView();
    }
...
//        toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        scanBtn.setOnClickListener(v ->{
            Intent intent = new Intent(ZxingMain.this, CaptureActivity.class);
            /*ZxingConfig是配置类
             *可以设置是否显示底部布局，闪光灯，相册，
             * 是否播放提示音  震动
             * 设置扫描框颜色等
...
//
//                            Toast.makeText(ZxingMain.this, "没有权限无法扫描呦", Toast.LENGTH_LONG).show();
//                        })
//                        .start();
