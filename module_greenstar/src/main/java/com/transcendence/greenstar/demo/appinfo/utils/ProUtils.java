package com.transcendence.greenstar.demo.appinfo.utils;
...
import com.transcendence.greenstar.demo.appinfo.mmkv.GSMMkvHelper;
...
public final class ProUtils {
    ...
    private static void getAppLists() {
        ...
        // 管理应用程序包
        PackageManager pManager = AppUtils.getPackageManager();
        // 获取手机内所有应用
        ...
        // 发送通知
        GSApp.sDevObservableNotify.onNotify(NotifyConstants.H_QUERY_APPLIST_END_NOTIFY);
    }
    ...
    public static int getAppSortType(){
        // 获取选中索引
        int sortPos = GSMMkvHelper.getInstance().getAppSort(); //SharedUtils.get(KeyConstants.KEY_APP_SORT, IPreference.DataType.INTEGER);
        // 获取最大值，防止负数
