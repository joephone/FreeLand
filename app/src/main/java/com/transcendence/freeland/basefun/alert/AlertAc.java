 ...
 */
public class AlertAc extends AppAc implements OnItemClickListener, OnDismissListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basefun_alert_main);
        ...
        ViewGroup extView = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.activity_basefun_alertext_form,null);
