...
/**
 * @author Joephone on 2019/4/16 23:54
...
public class UIIndexActivity extends AppAc implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.setClass(mActivity, AppConstantValue.uiIndex[position]);
